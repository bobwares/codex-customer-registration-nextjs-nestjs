...
-- Description: Seeds sample customer domain data for development and testing use cases.

BEGIN;

INSERT INTO customer_domain.postal_address (postal_address_id, line1, line2, city, state, postal_code, country)
VALUES
